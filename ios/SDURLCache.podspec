#
#  Be sure to run `pod spec lint SDURLCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SDURLCache-git"
  s.version      = "1.2a"
  s.summary      = "URLCache subclass with on-disk cache support on iPhone/iPad."

  s.description  = "URLCache subclass with on-disk cache support on iPhone/iPad.."
  ...
  # Or just: s.author    = "Varun Jindal"
  # s.authors            = { "Varun Jindal" => "varunjindal9@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Varun Jindal"
